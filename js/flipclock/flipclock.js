...
(function(jQuery) {
	...
	FlipClock.Factory = FlipClock.Base.extend({
		...
		constructor: function(obj, digit, options) {
			...
			this.running  = false;
			this.base(options);		
			this.jQuerywrapper = jQuery(obj).addClass(this.classes.wrapper);
	...
	FlipClock.Face = FlipClock.Base.extend({
		...
		createList: function(digit, options) {
			...
			//this.factory.jQuerywrapper.append(obj.jQueryobj);	
		...
		addDigit: function(digit) {
			...
			obj.jQueryobj.insertBefore(this.factory.lists[0].jQueryobj);
	...
	FlipClock.List = FlipClock.Base.extend({
		...
		constructor: function(factory, digit, options) {
			this.factory = factory;
			this.digit   = digit;
			this.jQueryobj    = this.createList();
			
			if(digit > 0) {
				this.select(digit);
			}
			
			this.factory.jQuerywrapper.append(this.jQueryobj);
		},
		...
		select: function(digit) {
			...
			var target = this.jQueryobj.find('[data-digit="'+digit+'"]');
			var active = this.jQueryobj.find('.'+this.classes.active).removeClass(this.classes.active);
			var before = this.jQueryobj.find('.'+this.classes.before).removeClass(this.classes.before);
			
			if(!this.factory.countdown) {
				if(target.is(':first-child')) {
					this.jQueryobj.find(':last-child').addClass(this.classes.before);
				}
				else {
				...
				if(target.is(':last-child')) {
					this.jQueryobj.find(':first-child').addClass(this.classes.before);
				}
				else {
		...
		play: function() {
			this.jQueryobj.addClass(this.factory.classes.play);
		},
		...
		stop: function() {
			...
			setTimeout(function() {
				t.jQueryobj.removeClass(t.factory.classes.play);
		...
		createList: function() {
			...
			var html = jQuery('<ul class="'+this.classes.flip+' '+(this.factory.running ? this.factory.classes.play : '')+'" />');
